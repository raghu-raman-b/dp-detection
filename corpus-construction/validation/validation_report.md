...
- true-None: **7** (want 5-7)
- multi-label: **22** (want 4-5) <- over the ceiling, label coverage took priority; further raised by post-build manual re-labeling
...
| Monetary: UI Misdirection                    |            15 |         4 |    yes    |
| Monetary: Never-Ending Lure                  |             2 |         3 |    yes    |
