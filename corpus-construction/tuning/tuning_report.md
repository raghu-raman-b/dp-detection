...
- true-None: **10** (target 10)  |  single-label: **11**  |  multi-label: **29**
...
| already in the validation set, excluded | 76 |
| repeat of an earlier review_id, collapsed | 5 |
| uncoded | 0 |
| eligible pool | 473 |
...
| field | distribution |
| --- | --- |
| stratum | targeted 34, random 16 |
| market | UK 28, IN 12, US 10 |
| star rating | 1 star 24, 2 star 5, 3 star 6, 4 star 6, 5 star 9 |
| distinct games | 34 |
| most from one game | 4 (no cap applied) |
| labels per review | mean 1.92 |

## label coverage

| label | left in pool | in sample | represented |
| --- | ---: | ---: | :---: |
| Temporal: Playing by Appointment | 45 | 6 | yes |
| Temporal: Daily Rewards | 15 | 1 | yes |
| Temporal: Grinding | 21 | 4 | yes |
| Temporal: Advertisement | 16 | 4 | yes |
| Temporal: Infinite Treadmill | 2 | 2 | yes |
| Temporal: Mandatory Marathon | 12 | 1 | yes |
| Monetary: Pay to Progress | 104 | 20 | yes |
| Monetary: Intermediate Currency | 23 | 4 | yes |
| Monetary: Deceptive Luxury | 2 | 1 | yes |
| Monetary: Recurring Fee | 8 | 1 | yes |
| Monetary: Gambling | 23 | 4 | yes |
| Monetary: Power Creep | 7 | 4 | yes |
| Monetary: Waste Aversion | 10 | 1 | yes |
| Monetary: Easy to Purchase | 17 | 3 | yes |
| Monetary: UI Misdirection | 14 | 4 | yes |
| Monetary: Never-Ending Lure | 3 | 1 | yes |
| Social: Forced Fellowship | 8 | 1 | yes |
| Social: Friend Spam / Impersonation | 1 | 1 | yes |
| Social: Reciprocity | 14 | 2 | yes |
| Social: Encourages Anti-Social Behavior | 5 | 1 | yes |
| Social: Fear of Missing Out (FOMO) | 0 | 0 | EMPTY POOL |
| Social: Competition | 50 | 8 | yes |
| Psychological: Easy to Get, Hard to Lose | 6 | 2 | yes |
| Psychological: Complete the Collection | 23 | 3 | yes |
| Psychological: Illusion of Control | 35 | 5 | yes |
| Psychological: Aesthetic Manipulation | 8 | 2 | yes |
| Psychological: Optimism and Frequency Biases | 8 | 2 | yes |
| Psychological: Reward Mania | 42 | 7 | yes |
| Technical: Fragmented Downloads | 3 | 1 | yes |
